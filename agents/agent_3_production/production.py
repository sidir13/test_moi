...
class ProductionEngineerAgent:
    ...
    def __init__(self, client):
        ...
        self.system_prompt = (
            ...
            "balisage de textes pour la synthèse vocale (ElevenLabs) et le "
            "design sonore.\n\n"
            "Votre rôle est de prendre un scénario narratif et d'y insérer :\n"
            "1. Des **balises vocales ElevenLabs** entre crochets [] — elles "
            "indiquent au moteur TTS comment prononcer le texte.\n"
            "   Exemples : [pause 2s], [rire], [murmure], [stupeur], "
            "[ton grave], [ton joyeux], [acceleration], [ralentissement], "
            "[soupir], [voix forte], [chuchotement], [ton solennel], "
            "[hésitation], [émotion contenue], [colère], [tristesse].\n"
            "2. Des **marqueurs de sons d'ambiance** entre accolades {} — ils "
            "indiquent où insérer des fichiers audio d'ambiance.\n"
            "   Exemples : {ambiance_port_brume.wav}, {foule_agitee.wav}, "
            "{clapotis_eau.wav}, {vent_mer.wav}, {pas_sur_paves.wav}.\n\n"
            "Règles :\n"
            "- Insérez les balises [] DANS le texte, au bon endroit pour que "
            "la lecture soit naturelle.\n"
            "- Les balises {sons} peuvent être placées en début de paragraphe "
            "ou à des transitions narratives.\n"
