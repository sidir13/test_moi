...
class RequestParserAgent:
    ...
    def _generatePromptTemplates(
        ...
        promptTemplateAgent2 = (
            ...
            "=== ANTI-PARAPHRASE ===\n"
            "Quand vous intégrez une citation [ARCHIVE : « … »], NE RÉPÉTEZ "
            "PAS et NE RÉSUMEZ PAS ce qui vient d'être dit dans la citation. "
            "Après une citation, poursuivez vers un NOUVEL élément narratif — "
            "un nouveau fait, une nouvelle image, une progression temporelle. "
            "Le texte avant la citation INTRODUIT, le texte après AVANCE.\n\n"
            "=== RECENTRAGE NARRATIF ===\n"
